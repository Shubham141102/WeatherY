...
function showWeaterReport(weather) {
    ...
    if(city_code==='400'){ 
        ...
        swal("Bad Input", "The City you entered does not match", "warning");
        reset();
    }
    else{
    ...
    <div class="location-deatils">
        <div class="city" id="city">Weather in ${weather.name}, ${weather.sys.country}</div>
        <div class="date" id="date">Date: ${dateManage(todayDate)}</div>
    </div>
